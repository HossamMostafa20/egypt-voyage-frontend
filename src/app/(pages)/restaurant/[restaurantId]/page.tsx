            ...
            <div className="pt-6">
                <div className="px-6">
                    <div className="relative w-full h-85 lg:h-105 overflow-hidden">
                        <Image src="/img3.jpg" alt="The Nile Ritz Carlton" fill priority />
                    </div>
                </div>
            </div>
            ...
            <div className="px-6 mt-3">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8">
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-[#FBBF6D]">Zaitouni Restaurant</h1>
                ...
                <div className="space-y-2 mt-2 text-[#0D3B66] font-medium">
                    ...
                    <p>Category :<span className="text-[#F4C27A] ml-2">Restaurant</span></p>
                </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                            <div className="flex justify-between flex-wrap">
                                <div>
                                    <h4 className="font-semibold text-lg text-[#0D3B66]">Maikel Youssef</h4>
